        ...
        static void OnToolbarGUI()
        {
            ...
            if (GUI.changed)
            {
                ...
                GameObject contentsRoot =
                    PrefabUtility.LoadPrefabContents("Assets/VPNest/UI/Prefabs/SplashLoadingScreen.prefab");

                SplashLoadingScreen splashLoadingScreen = contentsRoot.GetComponent<SplashLoadingScreen>();
                splashLoadingScreen.Setup();

                PrefabUtility.SaveAsPrefabAsset(contentsRoot, "Assets/VPNest/UI/Prefabs/SplashLoadingScreen.prefab");
